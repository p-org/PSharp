...
Write-Comment -prefix "." -text "Creating the P# NuGet package" -color "yellow"
...
$command = "pack $PSScriptRoot\NuGet\PSharp.nuspec $command_options"
$error_msg = "Failed to create the P# NuGet package"
Invoke-ToolCommand -tool $nuget -command $command -error_msg $error_msg

Write-Comment -prefix "." -text "Successfully created the P# NuGet package" -color "green"
