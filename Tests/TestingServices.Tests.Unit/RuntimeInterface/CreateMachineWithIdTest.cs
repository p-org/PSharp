...
namespace Microsoft.PSharp.TestingServices.Tests.Unit
{
    public class CreateMachineWithIdTest : BaseTest
    {
        ...
        public void TestCreateWithId5()
        {
            ...
            base.AssertFailed(test, "Cannot Send event Microsoft.PSharp.TestingServices.Tests.Unit.CreateMachineWithId+E" +
                " to a MachineId '' that was never previously bound to a machine of type Microsoft.PSharp.TestingServices." +
                "Tests.Unit.CreateMachineWithId+M2()", true);
        }
        ...
        public void TestCreateWithId6()
        {
            ...
            base.AssertFailed(test, "MachineId '' of a previously halted machine cannot be reused to create a new machine" +
                " of type Microsoft.PSharp.TestingServices.Tests.Unit.CreateMachineWithId+M2", false);
        }
        ...
        public void TestCreateWithId7()
        {
            ...
            base.AssertFailed(config, test, "Cannot Send event Microsoft.PSharp.TestingServices.Tests.Unit.CreateMachineWithId+E" +
                " to a MachineId '' that was never previously bound to a machine of type Microsoft.PSharp.TestingServices.Tests." +
                "Unit.CreateMachineWithId+M4()", false);
        }
    }
}
