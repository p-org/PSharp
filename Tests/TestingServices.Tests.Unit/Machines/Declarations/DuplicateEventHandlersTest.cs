...
namespace Microsoft.PSharp.TestingServices.Tests.Unit
{
    public class DuplicateEventHandlersTest : BaseTest
    {
        ...
        public void TestMachineDuplicateEventHandlerDo()
        {
            ...
            var bugReport = "Machine 'M1()' declared multiple " +
                "handlers for 'E' in state " +
                "'M1+Init'.";
        ...
        public void TestMachineDuplicateEventHandlerGoto()
        {
            ...
            var bugReport = "Machine 'M2()' declared multiple " +
                "handlers for 'E' in state " +
                "'M2+Init'.";
            AssertFailed(test, bugReport, false);
        }
        ...
        public void TestMachineDuplicateEventHandlerPush()
        {
            ...
            var bugReport = "Machine 'M3()' declared multiple " +
                "handlers for 'E' in state " +
                "'M3+Init'.";
            AssertFailed(test, bugReport, false);
        }
        ...
        public void TestMachineDuplicateEventHandlerInheritanceDo()
        {
            ...
            var bugReport = "Machine 'M4()' inherited multiple " +
                "handlers for 'E' from state " +
                "'M4+BaseState' in state " +
                "'M4+Init'.";
            AssertFailed(test, bugReport, false);
        }
        ...
        public void TestMachineDuplicateEventHandlerInheritanceGoto()
        {
            ...
            var bugReport = "Machine 'M5()' inherited multiple " +
                "handlers for 'E' from state " +
                "'M5+BaseState' in state " +
                "'M5+Init'.";
            AssertFailed(test, bugReport, false);
        }
        ...
        public void TestMachineDuplicateEventHandlerInheritancePush()
        {
            ...
            var bugReport = "Machine 'M6()' inherited multiple " +
                "handlers for 'E' from state " +
                "'M6+BaseState' in state " +
                "'M6+Init'.";
            AssertFailed(test, bugReport, false);
        }
        ...
        public void TestMachineDuplicateEventHandlerMixed()
        {
            ...
            var bugReport = "Machine 'M7()' declared multiple " +
                "handlers for 'E' in state " +
                "'M7+Init'.";
            AssertFailed(test, bugReport, false);
        }
