...
namespace Microsoft.PSharp.TestingServices.Tests.Unit
{
    public class MustHandleEventTest : BaseTest
    {
        ...
        public void TestMustHandleFail1()
        {
            ...
            string bugReport1 = "A must-handle event 'E' was sent to the halted machine '(Microsoft.PSharp.TestingServices.Tests.Unit.MustHandleEventTest+M1)-0'.\n";
            string bugReport2 = "Machine '(Microsoft.PSharp.TestingServices.Tests.Unit.MustHandleEventTest+M1)-0' halted before dequeueing must-handle event 'Microsoft.PSharp.TestingServices.Tests.Unit.MustHandleEventTest+E'.\n";
        ...
        public void TestMustHandleFail2()
        {
            ...
            string bugReport1 = "A must-handle event 'E' was sent to the halted machine '(Microsoft.PSharp.TestingServices.Tests.Unit.MustHandleEventTest+M2)-0'.\n";
            string bugReport2 = "Machine '(Microsoft.PSharp.TestingServices.Tests.Unit.MustHandleEventTest+M2)-0' halted before dequeueing must-handle event 'Microsoft.PSharp.TestingServices.Tests.Unit.MustHandleEventTest+E'.\n";
            var expectedFunc = new Func<HashSet<string>, bool>(bugReports =>
            {
                foreach (var report in bugReports)
                {
        ...
        public void TestMustHandleFail3()
        {
            ...
            string bugReport = "Machine '(Microsoft.PSharp.TestingServices.Tests.Unit.MustHandleEventTest+M5)-0' halted before dequeueing must-handle event 'Microsoft.PSharp.TestingServices.Tests.Unit.MustHandleEventTest+E'.\n";
