...
namespace Microsoft.PSharp.TestingServices.Tests
{
    public abstract class BaseTest : Common.BaseTest
    {
        ...
        protected ITestingEngine Test(Func<MachineTask> test, Configuration configuration = null) =>
            this.Test(test as Delegate, configuration);

        protected ITestingEngine Test(Func<IMachineRuntime, MachineTask> test, Configuration configuration = null) =>
            this.Test(test as Delegate, configuration);
        ...
        protected void TestWithError(Func<MachineTask> test, Configuration configuration = null, string expectedError = null,
            bool replay = false)
        {
            this.TestWithError(test as Delegate, configuration, new string[] { expectedError }, replay);
        }

        protected void TestWithError(Func<IMachineRuntime, MachineTask> test, Configuration configuration = null,
            string expectedError = null, bool replay = false)
        {
            this.TestWithError(test as Delegate, configuration, new string[] { expectedError }, replay);
        }
        ...
        protected void TestWithError(Func<MachineTask> test, Configuration configuration = null, string[] expectedErrors = null,
            bool replay = false)
        {
            this.TestWithError(test as Delegate, configuration, expectedErrors, replay);
        }
        ...
        protected void TestWithException<TException>(Func<MachineTask> test, Configuration configuration = null, bool replay = false)
            where TException : Exception
        {
            this.TestWithException<TException>(test as Delegate, configuration, replay);
        }

        protected void TestWithException<TException>(Func<IMachineRuntime, MachineTask> test, Configuration configuration = null,
            bool replay = false)
            where TException : Exception
        {
            this.TestWithException<TException>(test as Delegate, configuration, replay);
