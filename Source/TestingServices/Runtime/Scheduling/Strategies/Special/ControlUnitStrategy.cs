...
namespace Microsoft.PSharp.TestingServices.Scheduling.Strategies
{
    ...
    internal class ControlUnitStrategy : IProgramAwareSchedulingStrategy
    {
        ...
        public void RecordStartMachine(Machine machine, EventInfo initialEvent) => (this.CurrentStrategy as IProgramAwareSchedulingStrategy)?.RecordStartMachine(machine, initialEvent);

        public void RecordReceiveEvent(Machine machine, EventInfo eventInfo) => (this.CurrentStrategy as IProgramAwareSchedulingStrategy)?.RecordReceiveEvent(machine, eventInfo);
