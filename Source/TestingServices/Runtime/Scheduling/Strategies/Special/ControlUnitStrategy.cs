...
namespace Microsoft.PSharp.TestingServices.Scheduling.Strategies
{
    ...
    internal class ControlUnitStrategy : IProgramAwareSchedulingStrategy
    {
        ...
        public void RecordStartMachine(Machine machine, Event initialEvent, EventInfo initialEventInfo) => (this.CurrentStrategy as IProgramAwareSchedulingStrategy)?.RecordStartMachine(machine, initialEvent, initialEventInfo);

        public void RecordReceiveEvent(Machine machine, Event evt, EventInfo eventInfo) => (this.CurrentStrategy as IProgramAwareSchedulingStrategy)?.RecordReceiveEvent(machine, evt, eventInfo);

        public void RecordSendEvent(AsyncMachine sender, MachineId targetMachineId, EventInfo eventInfo, Event e) => (this.CurrentStrategy as IProgramAwareSchedulingStrategy)?.RecordSendEvent(sender, targetMachineId, eventInfo, e);
