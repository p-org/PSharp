...
namespace Microsoft.PSharp.TestingServices.Runtime
{
    ...
    internal class SystematicTestingRuntime : MachineRuntime
    {
        ...
        /// </summary>
        internal void RunTestHarness(Action<IMachineRuntime> testAction, string testName)
        {
        ...
        /// Enqueues an event to the machine with the specified id.
        /// </summary>
        protected virtual EnqueueStatus EnqueueEvent(Machine machine, Event e, AsyncMachine sender, Guid opGroupId,
