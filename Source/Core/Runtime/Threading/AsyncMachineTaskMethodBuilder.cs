...
{
    /// <summary>
    /// Represents a builder for asynchronous methods that return a <see cref="MachineTask"/>.
    /// </summary>
    [StructLayout(LayoutKind.Auto)]
    public struct AsyncMachineTaskMethodBuilder
    {
        /// <summary>
        ...
        public MachineTask Task
        {
            get
            {
                ...
                else
                {
                    ...
                    return MachineRuntime.CurrentScheduler.CreateCompletionSourceMachineTask(this.MethodBuilder.Task);
                }
            }
        }

        /// <summary>
        /// Creates an instance of the <see cref="AsyncMachineTaskMethodBuilder"/> struct.
        /// </summary>
        public static AsyncMachineTaskMethodBuilder Create()
        {
...
#pragma warning restore CA1822 // Mark members as static
    ...
    /// <summary>
    /// Represents a builder for asynchronous methods that return a <see cref="MachineTask{TResult}"/>.
    /// </summary>
    [StructLayout(LayoutKind.Auto)]
    public struct AsyncMachineTaskMethodBuilder<TResult>
    {
        /// <summary>
        /// The <see cref="AsyncTaskMethodBuilder"/> to which most operations are delegated.
        /// </summary>
...
#pragma warning restore IDE0044 // Add readonly modifier
        ...
        /// Gets the task for this builder.
        /// </summary>
        public MachineTask<TResult> Task
        {
            get
            {
                if (this.IsCompleted)
                {
                    ...
                    return MachineTask.FromResult(this.Result);
                }
                else
                {
        ...
        /// <summary>
        /// Creates an instance of the <see cref="AsyncMachineTaskMethodBuilder{TResult}"/> struct.
        /// </summary>
#pragma warning disable CA1000 // Do not declare static members on generic types
        public static AsyncMachineTaskMethodBuilder<TResult> Create()
        {
