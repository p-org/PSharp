...
#pragma warning restore 618
       ...
       /// </summary>
        ...
        /// </summary>
        internal EnqueueStatus Enqueue(EventInfo eventInfo)
        {
            ...
            return this.Inbox.Enqueue(eventInfo);
        }
        ...
        internal async Task RunEventHandlerAsync()
        {
            ...
            {
                DequeueStatus dequeueStatus = this.Inbox.Dequeue(out EventInfo nextEventInfo);
                if (dequeueStatus is DequeueStatus.Success)
                {
                ...
                else if (dequeueStatus is DequeueStatus.Raised)
                {
                    this.Runtime.NotifyHandleRaisedEvent(this, nextEventInfo);
                }
                else if (dequeueStatus is DequeueStatus.Default)
                {
                ...
                else if (dequeueStatus is DequeueStatus.NotAvailable)
                {
                    break;
                }
                ...
                if (dequeueStatus is DequeueStatus.Success)
                {
                    ...
                    lastDequeuedEvent = nextEventInfo.Event;
