	...
	public abstract class TMachine : Machine
	{
        ...
        protected TimerId StartTimer(object payload, bool IsPeriodic, int period)
        {
            ...
            TimerId tid = new TimerId(
                    this.CreateMachine(this.Runtime.GetTimerMachineType(), new InitTimer(this.Id, payload, IsPeriodic, period)),
                    payload);
		...
		protected async void StopTimer(TimerId timer, bool flush = true)
		{
