...
namespace TailSpin
{
	...
	/// </summary>
	[DataContract]
	class SurveyHandlerInitEvent : RsmInitEvent
	{
		/// <summary>
		/// Handle to the main TailSpinCore machine.
		/// </summary>
		[DataMember]
		public IRsmId TailSpinCoreMachine;
		...
		public SurveyHandlerInitEvent(IRsmId TailSpinCoreMachine, int SurveyDuration, int SubscriberId, int SurveyId)
		{
	...
	/// </summary>
	[DataContract]
	class SubscriberInitEvent : RsmInitEvent
	{
		/// <summary>
		...
		public SubscriberInitEvent(IRsmId TailSpinCoreMachine)
		{
			this.TailSpinCoreMachine = TailSpinCoreMachine;
		}
	}
	...
	class RegisterSubscriberEvent : Event
	{
		...
		/// </summary>
		[DataMember]
		public IRsmId Subscriber;

		public RegisterSubscriberEvent(IRsmId Subscriber)
		{
