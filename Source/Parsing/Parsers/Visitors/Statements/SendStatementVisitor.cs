...
namespace Microsoft.PSharp.Parsing
{
    ...
    /// </summary>
    internal sealed class SendStatementVisitor : BaseParseVisitor
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        /// <param name="tokenStream">TokenStream</param>
        internal SendStatementVisitor(TokenStream tokenStream)
            : base(tokenStream)
        {
        ...
        internal void Visit(BlockSyntax parentNode)
        {
            ...
            var node = new SendStatementNode(base.TokenStream.Program, parentNode);
            ...
            if (base.TokenStream.Program is PSharpProgram)
            {
                ...
                var machineIdentifier = new ExpressionNode(base.TokenStream.Program, parentNode);
            ...
            else
            {
                if (base.TokenStream.Done ||
                    ...
                    base.TokenStream.Peek().Type != TokenType.This &&
                    base.TokenStream.Peek().Type != TokenType.Payload &&
                    base.TokenStream.Peek().Type != TokenType.Keys &&
                ...
                var machineIdentifier = new PExpressionNode(base.TokenStream.Program, parentNode);
