//-----------------------------------------------------------------------
// <copyright file="PBaseActionDeclarationNode.cs">
...
namespace Microsoft.PSharp.Parsing.Syntax.P
{
    ...
    /// </summary>
    public abstract class PBaseActionDeclarationNode : PSharpSyntaxNode
    {
        #region fields
        ...
        public PBaseActionDeclarationNode(PMachineDeclarationNode machineNode, PStateDeclarationNode stateNode)
        {
        ...
        private void RewriteSendStatement()
        {
            ...
            var startIdx = this.Index;
            while (this.RewrittenStatements[this.Index].Type != TokenType.Comma)
            {
                this.Index++;
            }
            ...
            var eventId = this.RewrittenStatements[this.Index].Text;
            this.RewrittenStatements[this.Index] = new Token(eventId, TokenType.EventIdentifier);
            this.Index++;
            ...
            if (this.RewrittenStatements[this.Index].Type == TokenType.Comma)
            {
                this.RewrittenStatements.RemoveAt(this.Index);
                while (this.RewrittenStatements[this.Index].Type != TokenType.Semicolon)
                {
        ...
        private void RewriteIdentifier()
        {
            if (this.Machine == null || this.State == null ||
                ...
                this.Machine.FunctionDeclarations.Any(val => val.Identifier.TextUnit.Text.
                Equals(this.RewrittenStatements[this.Index].Text))))
            {
                return;
            }
