...
namespace Microsoft.PSharp.LanguageServices.Rewriting.PSharp
{
    ...
    public class ProjectionNode
    {
        ...
        /// </summary>
        internal void IncrementCodeChunkLength(int increment) => this.CodeChunk.RewrittenLength += increment;
        ...
        /// </summary>
        internal void AddOffset(int offset) => this.RewrittenCumulativeOffset += offset;
